...
Read [shared shot composition](../../kinex-agent-workspace/references/shot-composition.md) for current fields, authored-prompt refresh, source-frame ratio and the audio-intent handoff. Validate actual returned operation inputs and reference assets before treating the queued request as correct.
